...
프로젝트 개요
이 프로젝트는 Grafana, Loki, Prometheus를 활용하여 모니터링 및 로깅을 구현하는 데 중점을 둡니다. 효율적인 데이터 시각화 및 로깅 솔루션을 제공하며, 애플리케이션의 상태를 실시간으로 모니터링할 수 있습니다.
...
시스템 경고 및 알림 설정
Prometheus 설정 예시
아래는 Prometheus에서 mysqld_exporter, node_exporter, promtail을 사용하는 예제 설정 파일입니다:
